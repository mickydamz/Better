...
// Route url
Route::get('/', 'InvestmentController@index')->middleware('auth');

Route::resource('masterwithdraws','MasterWithdrawController')->middleware('auth');

Route::resource('masterinvestments','MasterInvestmentController')->middleware('auth');

Route::resource('masteraccounts','MasterAccountController')->middleware('auth');
...
Route::resource('withdraws','WithdrawController')->middleware('auth');
